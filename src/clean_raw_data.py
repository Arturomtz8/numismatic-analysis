...
countries = [
    'Isla Bassas de India', 'Isla Komplece', 'Estados Unidos', 'Irlanda Del Norte',
    'Sudan Del Sur', 'Corea Del Norte', 'Indochina Francesa', 'Republica Dominicana',
    'Cabo Verde', 'Republica Checa', 'Gran Bretaña', 'Territorios Ecuatoriales',
    'Territorios Articos', 'Venezuela', 'Transnistria', 'Bolivia',
    'Argentina', 'Paraguay', 'Perú', 'Cuba', 'Francia', 'Uruguay',
    'Inglaterra', 'Chile', 'Estonia', 'Mexico', 'Turquia', 'Guatemala',
    'Vietnam', 'Brasil', 'Oman', 'Rumania', 'Nigeria', 'España',
    'Afganistan', 'Ghana', 'Grecia', 'Suiza', 'Georgia', 'Libia',
    'Portugal', 'Colombia', 'China', 'Tajikistan', 'Rusia', 'Siria',
    'Congo', 'Croacia', 'Alemania', 'Arabia Saudita', 'Yemen', 'Africa', 'Europa'
]
...
def extract_country(title):
    ...
    for country in countries:
        pattern = r'^\s*' + re.escape(country.lower()) + r'\s*(?:año|set|lote|coleccion|billete|billlete|bono|moneda|\d+|$)'
